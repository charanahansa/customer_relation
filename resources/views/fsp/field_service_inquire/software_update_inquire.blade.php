...
@section('title')
    Software Update Inquire
@endsection

@section('body')

<form method="POST" name="form_name" action="{{route('fs_software_update_inquire_process')}}">
				...
				<div class="table-responsive">
					<div id="tbldiv" style="width: 100%;">
						...
						<table id="tblgrid1" class="table table-hover table-sm table-bordered">
							...
							@if(count($SW['report_table']))

								<tbody>
									@foreach($SW['report_table'] as $row)
										...
										<tr style="font-family: Consolas; font-size: 13px;">
											...
											<td colspan="6"><b> {{$row->merchant}} </b> </td>
...
<script>
    ...
    function openTicket(ticket_number, bank){
        ...
        document.getElementById("workflow_id").value = 4;
