...
@section('title')
    Re Initialization Inquire
@endsection

@section('body')

<form method="POST" name="form_name" action="{{route('fs_re_initialization_inquire_process')}}">
				...
				<div class="table-responsive">
					<div id="tbldiv" style="width: 100%;">
						...
						<table id="tblgrid1" class="table table-hover table-sm table-bordered">
							<?php $icount = 1; ?>
							<thead>
								<tr style="font-family: Consolas; font-size: 13px; background-color: #acddde;">
									<th>No</th>
									<th>Ticket No.</th>
									<th>Ticket Date</th>
									<th>TID</th>
							...
							@if(count($RE['report_table']))

								<tbody>
									@foreach($RE['report_table'] as $row)
										...
										<tr style="font-family: Consolas; font-size: 13px;">
											...
											<td colspan="5"><b> {{$row->merchant}} </b> </td>
                                        ...
                                        <tr style="font-family: Consolas; font-size: 12px;">
											...
											<td colspan="2"><b> {{$row->field_officer}} </b> </td>
										...
										<tr style="font-family: Consolas; font-size: 12px;">
											...
											<td colspan="2"><b> {{$row->sub_status}} </b> </td>
...
<script>
    ...
    function openTicket(ticket_number, bank){
        ...
        document.getElementById("workflow_id").value = 3;
