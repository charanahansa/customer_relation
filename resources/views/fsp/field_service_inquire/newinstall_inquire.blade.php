...
@section('title')
    New Installation Inquire
@endsection

@section('body')

<form method="POST" name="form_name" action="{{route('fs_new_inquire_process')}}">
...
<script>
    ...
    function openTicket(ticket_number, bank){
        ...
        document.getElementById("workflow_id").value = 2;
