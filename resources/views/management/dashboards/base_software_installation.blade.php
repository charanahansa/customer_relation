...
<?php
    ...
    if(isset($base_software_installation['selected_date'])){

        $from_date = $base_software_installation['selected_date'][0];
        $to_date = $base_software_installation['selected_date'][1];
    }
...
@section('body')
            ...
            <h3> Base Software Installation Workflow </h3>
            <hr>

            <form method="POST" action="{{route('base_software_installation_management_process')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="card bg-light mb-3" style="max-width: 18rem;">
                            <div class="card-header">Total Base Software Installation Count</div>
                            <div class="card-body">
                                <h2 class="card-title" style="text-align: center;">
                                    @if( isset($base_software_installation['base_software_installation_count']) )
                                        @foreach($base_software_installation['base_software_installation_count'] as $row)
                                            {{$row->base_software_installation_count}}
                                        @endforeach
                                    @else
                                        0
                                    @endif
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-hover table-sm table-bordered" style='font-family: Consolas; font-size: 13px;'>
                                    ...
                                    @if( isset($base_software_installation['base_software_installation_bank_count']) )
                                        @if(count($base_software_installation['base_software_installation_status_count']) >= 1)
                                            @foreach($base_software_installation['base_software_installation_bank_count'] as $row)
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-hover table-sm table-bordered" style='font-family: Consolas; font-size: 13px;'>
                                    ...
                                    @if( isset($base_software_installation['base_software_installation_status_count']) )
                                        @if(count($base_software_installation['base_software_installation_status_count']) >= 1)
                                            @foreach($base_software_installation['base_software_installation_status_count'] as $row)
...
<script>
    ...
    function getBank(bank){
        ...
        $.ajax({
            ...
            url:  "{{ route('get_bank_wise_status_wise_base_software_installation_management_count') }}",
            type: 'GET',
    ...
    function getStatus(status){
        ...
        $.ajax({
            ...
            url:  "{{ route('get_status_wise_bank_wise_base_software_installation_management_count') }}",
            type: 'GET',
    ...
    function detail(text){
        ...
        $.ajax({
            ...
            url:  "{{route('get_base_software_installation_management_detail')}}",
            type: 'GET',
            ...
            success: function(data) {
                ...
                myObj = JSON.parse(data);
                document_table = myObj['base_software_installation_detail'];
                ...
                row_header += "<td style='width: 7%;'>Bank</td>";
                row_header += "<td style='width: 10%;'>Serial No.</td>";
                row_header += "<td style='width: 20%;'>Model</td>";
                row_header += "<td style='width: 15%;'>Officer</td>";
                ...
                if((Object.keys(document_table).length) >= 1){
                    ...
                    for (var i = 0; i < (Object.keys(document_table).length); i++) {
                        ...
                        base_software_installation_officer = document_table[i]['officer_name'];
                        if(base_software_installation_officer == null){
                            base_software_installation_officer = '-';
                        }

                        base_software_installation_status = document_table[i]['status'];
                        base_software_installation_status = (base_software_installation_status.charAt(0).toUpperCase() + base_software_installation_status.slice(1));
                        ...
                        row_detail += "<td >" + document_table[i]['serialno'] + "</td>";
                        row_detail += "<td >" + document_table[i]['model'] + "</td>";
                        row_detail += "<td >" + base_software_installation_officer + "</td>";
                        row_detail += "<td >" + base_software_installation_status  + "</td>";
                        row_detail +=  "</tr>";
