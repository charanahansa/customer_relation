...
@section('body')
	...
	<br>
    <h5 style="width: 100%; text-align: center;"> Merchant Removal Workflow Report </h5>
	<br>

	<form method="POST" name="form_name" action="{{route('merchant_removal_report_process')}}">
				...
				<div class="carousel-item active">
					...
					<div class="card" >
						...
						<div class="card-body" >
                            ...
                            <div class="form-row">
                                <label for="fromdate" class="col-sm-3 col-form-label-sm">Removed By</label>
                                <div class="col-sm-9">
                                    <select name='removed_by' id="removed_by" class="form-control form-control-sm">
                            ...
                            <div class="form-row">
                                <label for="tid" class="col-sm-3 col-form-label-sm">Return To</label>
                                <div class="col-sm-9">
                                    <select name='return_to' id="return_to" class="form-control form-control-sm">
                                        <option value="bank">Bank</option>
                                        <option value="epic" selected>Epic Lanka</option>
                                    </select>
                                </div>
                            </div>
