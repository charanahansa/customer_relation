...
@section('body')
	...
	<br>
    <h5 style="width: 100%; text-align: center;"> Profile Sharing Workflow Report </h5>
	<br>

	<form method="POST" name="form_name" action="{{route('profile_sharing_report_process')}}">
				...
				<div class="carousel-item active">
					...
					<div class="card" >
						...
						<div class="card-body" >
                            ...
                            <div class="form-row">
								<label for="fromdate" class="col-sm-3 col-form-label-sm">From Share TID</label>
								<div class="col-sm-3">
									<input type="text" name="from_share_tid" id="from_share_tid" class="form-control form-control-sm" value="">
								</div>
								<label for="todate" class="col-sm-3 col-form-label-sm">To Share TID</label>
								<div class="col-sm-3">
									<input type="text" name="to_share_tid" id="to_share_tid" class="form-control form-control-sm" value="">
								</div>	
							</div>
							...
							<div class="form-row">
								<div class="col-sm-12">
									<select  name="officer[]" class="form-control form-control-sm" id="officer" multiple style="height:300px; width:100%; " size="20" >
										@foreach($PS['officers'] as $officers)
