...
@section('title')
    Terminal InOut Report
@endsection

@section('body')

	<br>
    <h5 style="width: 100%; text-align: center;"> Terminal InOut Workflow Report </h5>
	<br>

	<form method="POST" name="form_name" action="{{route('terminal_inout_report_process')}}">
