...
@section('body')
	...
	<br>
    <h5 style="width: 100%; text-align: center;"> New Installation Workflow Report </h5>
	<br>

	<form method="POST" name="form_name" action="{{route('new_installation_report_process')}}">
							...
							<div class="form-row">
								<div class="col-sm-12">
									<select  name="tables[]" class="form-control form-control-sm" id="tables" multiple style="height:300px; width:100%; " size="20" >
										<option value='newinstall' selected>Newinstall</option>
										<option value='newinstall_ftl_view'>Newinstall Field Service Team Lead</option>
										<option value='newinstall_tmc_view'>Newinstall Tmc</option>
										<option value='newinstall_tp_view'>Newinstall Terminal Programmer</option>
										<option value='newinstall_fs_view'>Newinstall Field Service Officer</option>
									</select>
								</div>
