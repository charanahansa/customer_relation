					...
					<div class="card" >
						...
						<div class="card-body" >
                            ...
                            <div class="mb-2 row">
								...
								<div class="col-sm-3">
									<select name="user_negligent" id="user_negligent" class="form-select form-select-sm">
                            ...
                            <div class="mb-2 row">
								...
								<div class="col-sm-3">
									<select name="epic_warranty" id="epic_warranty" class="form-select form-select-sm">
                                        <option value =0>No</option>
                                        <option value =1>Yes</option>
                                    </select>
								</div>
								...
								<div class="col-sm-3">
									<select name="seller_warranty" id="seller_warranty" class="form-select form-select-sm">
                                        <option value =0>No</option>
                                        <option value =1>Yes</option>
                                    </select>
								</div>
							...
							<div class="mb-2 row">
								...
								<div class="col-sm-3">
									<select name="quotation" id="quotation" class="form-select form-select-sm">
                                        <option value =0>No</option>
                                        <option value =1>Yes</option>
                                    </select>
								</div>
				...
				<div class="carousel-item">
					...
					<div class="card" >
						...
						<div class="card-body" >
							...
							<div class="mb-2 row">
								<div class="col-sm-12">
									<select  name="services[]" class="form-select form-select-sm" id="services" multiple style="height:300px; width:100%; " size="20" >
				...
				<div class="carousel-item">
					...
					<div class="card" >
						...
						<div class="card-body" >
							...
							<div class="mb-2 row">
								<div class="col-sm-12">
									<select  name="fault[]" class="form-select form-select-sm" id="fault" multiple style="height:300px; width:100%; " size="20" >
				...
				<div class="carousel-item">
					...
					<div class="card" >
						...
						<div class="card-body" >
							...
							<div class="mb-2 row">
								<div class="col-sm-12">
									<select  name="spare_part[]" class="form-select form-select-sm" id="spare_part" multiple style="height:300px; width:100%; " size="20" >
				...
				<div class="carousel-item">
					...
					<div class="card" >
						...
						<div class="card-body" >
							...
							<div class="mb-2 row">
								<div class="col-sm-12">
									<select  name="spare_part_usage[]" class="form-select form-select-sm" id="spare_part_usage" multiple style="height:300px; width:100%; " size="20" >
										@foreach($JR['spare_part'] as $spare_parts)
											<option value="{{$spare_parts->spare_part_id}}"> {{$spare_parts->spare_part_name}} </option>
										@endforeach
									</select>
				...
				<div class="carousel-item">
					...
					<div class="card" >
						...
						<div class="card-body" >
							...
							<div class="mb-2 row">
								<div class="col-sm-12">
									<select  name="spare_part_removed[]" class="form-select form-select-sm" id="spare_part_removed" multiple style="height:300px; width:100%; " size="20" >
										@foreach($JR['spare_part'] as $spare_parts)
											<option value="{{$spare_parts->spare_part_id}}"> {{$spare_parts->spare_part_name}} </option>
										@endforeach
									</select>
