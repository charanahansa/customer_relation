		...
		<div class="navbar_mega_menu">
            ...
            <div class="dropdown_mega_menu">
                ...
                <div class="dropdown_single_menu_content">
                    ...
                    <a href="{{route('fault')}}">Fault</a>
                    <a href="{{route('relevant_detail')}}">Relevant Detail</a>
                    <a href="{{route('action_taken')}}">Action Taken</a>
            ...
            <div class="dropdown_mega_menu">
                ...
                <div class="dropdown_single_menu_content">
                    <a href="{{route('master_list')}}">Master List</a>
                </div>
            </div>
