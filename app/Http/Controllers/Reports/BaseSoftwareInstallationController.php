...
use App\Models\Reports\BaseSoftwareInstall;

use PhpOffice\PhpSpreadsheet\Spreadsheet;
use PhpOffice\PhpSpreadsheet\Writer\Xlsx;
use PhpOffice\PhpSpreadsheet\Style\Border;

class BaseSoftwareInstallationController extends Controller {
    ...
    public function index(){
        ...
        $objBaseSoftwareInstallation = new BaseSoftwareInstall();

		$data['bank'] = $objBaseSoftwareInstallation->get_bank();
		$data['model'] = $objBaseSoftwareInstallation->get_models();
		$data['officers'] = $objBaseSoftwareInstallation->get_officers();
		$data['sub_status'] = $objBaseSoftwareInstallation->get_sub_status();
		$data['status'] = $objBaseSoftwareInstallation->get_status();

        return view('reports.base_software_installation')->with('BSI', $data);
    }

    public function base_software_installation_process(Request $request){
		...
		$result = $objBaseSoftwareInstallation->get_report($input['from_date'], $input['to_date'], $total_filter, $tables);
	...
	private function genarate_excel_file($resultset, $tables){
		...
		$filename = 'BaseSoftwareInstallation_Report';
